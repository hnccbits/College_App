...
class LostFirstActivity : AppCompatActivity(), CameraDialog.DialogListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener(View.OnClickListener { startActivity(Intent(this@LostFirstActivity, LostSecondActivity::class.java)) })
