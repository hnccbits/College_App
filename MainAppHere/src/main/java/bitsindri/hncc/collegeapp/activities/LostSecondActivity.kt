...
class LostSecondActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        linear_add.setOnClickListener{
            startActivity(Intent(this,LostThirdActivity::class.java))
        }
        ...
        linear_address.setOnClickListener{
            startActivity(Intent(this@LostSecondActivity, LostThirdActivity::class.java))
        }

        btn_submit.setOnClickListener{
            startActivity(Intent(this@LostSecondActivity, LostDetailActivity::class.java))
        }
